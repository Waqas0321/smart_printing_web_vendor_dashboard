...
class SideWithRepetitionScreen extends StatelessWidget {
  SideWithRepetitionScreen({super.key, required this.overlayEntry});
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: Column(
                                ...
                                children: [
                                  CustomTextWidget(
                                    text: "Number Box with Multiplier",
                                    fontSize: 15,
                                      ...
                                      children: [
                                          ...
                                          return Wrap(
                                            ...
                                            children: fieldGeneratorController
                                                ...
                                                label: Column(
                                                  ...
                                                  children: [
                                                    CustomTextWidget(
                                                      text: "Sides :${entry.value.sides.toString()}",
                                                    ),
                                                    Gap(4),
                                                    CustomTextWidget(
                                                      text: "Repetition on Side 1 :${entry.value.repetitionOnSide1.toString()}",
                                                    ),
                                                    Gap(4),
                                                    CustomTextWidget(
                                                      text: "Repetition on Side 2, 3, 4, 5 :${entry.value.repetitionMultiplier.toString()}",
                                                    ),
                                                  ],
                                                ),
                                                deleteIcon: Icon(
                                        ...
                                        Row(
                                          children: [
                                                ...
                                                child: Column(
                                                  ...
                                                  children: [
                                                    Row(
                                                      ...
                                                      children: [
                                                        CustomTextWidget(
                                                          text: "Repetition on Side 2, 3, 4, 5",
                                                          fontSize: 14,
                                                          fontWeight: FontWeight.w600,
                                                          textColor: AppColors.black,
                                                        ),
                                            ...
                                            SizedBox(width: AppSizes().getWidthPercentage(3),)
                                          ],
                                        ),
                                      ],
                                    ),
