...
class AddProductScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    AddProductController productServiceInfoController =
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        CustomTextButton(color: AppColors.halfWhite2, text: "Back", hasBorder: false, textColor: AppColors.brown, onPress: () {
                   ...
                   isLarge? Row(
                      ...
                      children: [
                        Obx(
                          () =>  GestureDetector(
                            onTap: () {
                                productServiceInfoController.selectedOption.value = "Non-Inventory";
                            },
                            child: Container(
                              padding: EdgeInsets.all(8),
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: productServiceInfoController.selectedOption.value == "Non-Inventory"
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      CustomTextWidget(
                                        ...
                                        fontWeight: FontWeight.w600,
                                        fontSize: 16,
                                        textColor: productServiceInfoController.selectedOption.value == "Non-Inventory"
                                            ? AppColors.black
                                            : AppColors.brown.withOpacity(0.6),
                                      ),
                                      SizedBox(
                        ...
                        Obx(
                          () =>  GestureDetector(
                            onTap: () {
                              productServiceInfoController.selectedOption.value = "Service";
                            },
                            child: Container(
                              padding: EdgeInsets.all(8),
                              decoration: BoxDecoration(
                                border: Border.all(
                                  color: productServiceInfoController.selectedOption.value == "Service"
                                      ? AppColors.lightPrimary
                                      : AppColors.brown.withOpacity(0.3),
                                  width: 2,
                                ),
                                  ...
                                  Column(
                                    ...
                                    children: [
                                      CustomTextWidget(
                                        ...
                                        fontWeight: FontWeight.w600,
                                        fontSize: 16,
                                        textColor: productServiceInfoController.selectedOption.value == "Service"
                                            ? AppColors.black
                                            : AppColors.brown.withOpacity(0.6),
                                      ),
                                      SizedBox(
                    ...
                    productServiceInfoController.selectedOption.value == "Non-Inventory"? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      mainAxisAlignment: MainAxisAlignment.start,
                      children: [
                        Gap(28),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(6),
                                  border: Border.all(color: AppColors.brown.withOpacity(0.5)), // Border color
                                ),
                                child: DropdownButton<String>(
                                  ...
                                  value: productServiceInfoController.selectedCategory.value,
                                  items: [
                                    DropdownMenuItem(
                                      value: "Category 1",
                                      child: CustomTextWidget(
                                  ...
                                  onChanged: (value) {
                                    productServiceInfoController.selectedCategory.value = value!;
                                  },
                                ),
                              ),
                            ],
                                  ...
                                  children: [
                                    ...
                                    Container(
                                      ...
                                      child: DropdownButton<String>(
                                        ...
                                        value: productServiceInfoController.selectedIncomeAccount.value,
                                        items: [
                                          DropdownMenuItem(
                                            value: "403 Services",
                                            child: CustomTextWidget(
                                        ...
                                        onChanged: (value) {
                                          productServiceInfoController.selectedIncomeAccount.value = value!;
                                        },
                                      ),
                                    ),
                                  ],
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<String>(
                                  ...
                                  value: productServiceInfoController.selectedTax.value,
                                  items: [
                                    DropdownMenuItem(
                                      value: "1000",
                                      child: CustomTextWidget(
                                  ...
                                  onChanged: (value) {
                                    productServiceInfoController.selectedTax.value = value!;
                                  },
                                ),
                              ),
                            ],
