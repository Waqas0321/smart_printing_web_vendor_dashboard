                                ...
                                Container(
                                  ...
                                  child: Column(
                                    children: [
                                      Container(
                                        width: AppSizes().getWidthPercentage(100),
                                        padding: AppSizes().getCustomPadding(top: 2.5, bottom: 2.5, right: 0, left: 0),
                                        decoration: BoxDecoration(
                                        ...
                                        child: Table(
                                          ...
                                          columnWidths: const <int, TableColumnWidth>{
                                            ...
                                            1: FlexColumnWidth(1),  // Estimation ID
                                            2: FlexColumnWidth(2),  // Product Type
                                            3: FlexColumnWidth(2),  // Customer Name
                                            4: FlexColumnWidth(2),  // Posted By
                                            5: FlexColumnWidth(1.5), // Status
                                            6: FlexColumnWidth(2),  // Countdown Timer
                                            7: FlexColumnWidth(3),  // Actions
                                          },
                                          children: [
                                            TableRow(
                                              decoration: BoxDecoration(color: AppColors.halfWhite2),
                                              children: [
                                                SizedBox(), // Placeholder for the checkbox column
                                                CustomTextWidget(
                                                  text: "ESTIMATION ID",
                                                  fontWeight: FontWeight.w600,
                                                  fontSize: 12,
                                      ...
                                      Gap(12),
                                      ListView.separated(
                                        itemCount: estimationController.boolList.length,
                                            ...
                                            children: [
                                              TableRow(
                                                children: [
                                                  Obx(
                                                        () => Checkbox(
                                                      value: estimationController.boolList[index].value,
                                                      onChanged: (value) {
                                                        estimationController.toggleCheckbox(index, value);
                                                      },
                                                        ...
                                                        Expanded(
                                                          child: CustomTextButton(
                                                            ...
                                                            onPress: () {
                                                              Get.dialog(
                                                                CustomDialgueBox(
                                                                  firstController: estimationController.nameController,
                                                                  secondsController:
                                                                  estimationController.detailsController,
                                                                  isThird: true,
                                                                  iconPath: AppIcons.InfoSquare,
                                                                  heading: "COJD Details",
                                                                  isLarge: isLarge,
                                                                  onPress: () {
                                                                    Get.back();
                                                                  },
