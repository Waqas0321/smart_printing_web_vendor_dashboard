...
class CustomerRequiredQuantityController extends GetxController{
  ...
  void onInit() {
    super.onInit();
    initializeControllers(cRequiredQuantity.length);
  }
  @override
  void onClose() {
  ...
  List<Map<String, dynamic>> collectUserInputs() {
    ...
    for (int index = 0; index <cRequiredQuantity.length; index++) {
      ...
      List<String> requiredQuantities = cRequiredQuantity;
